...
<html>
    ...
    <body>
        ...
        <div>
          ...
          <label for="scredit">Credit Point:</label>
    			<input type="text" name="scredit"><br><br>

          <label for="sduration">Duration</label>
    			<select name="sduration">
          ...
          <?php
              ...
              if ($link === false) {
               ...
               $sql = mysqli_query($link, "SELECT AsgID, aName FROM assignment");
              while ($row = $sql->fetch_assoc()){
              echo "<option value='{$row['AsgID']}'>{$row['aName']}</option>";
              }
              ?>
              </select>
