    ...
    <body>
        ...
        <div>
            ...
            <form method="post" action="AddBooks.php">
    			...
    			<input type="text" name="bnumber"><br><br>

                <label for="bborrow">Borrow Date:</label>
    			<input type="text" name="bborrow"><br><br>

                <label for="breturn">Return Date:</label>
    			<input type="text" name="breturn"><br><br>
